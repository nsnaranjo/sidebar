pipeline {
    agent { label 'spad-platform-front' } // Define the Jenkins agent label for running this pipeline
    ...
    environment { // Set up environment variables
        ...
        GIT_URL = 'https://innerconsulting.mytuleap.com/plugins/git/spad-dashboard/SPAD-DASHBOARD.git'
        TULEAP_REPOSITORY_ID = '106' // Tuleap repository ID for status notifications
